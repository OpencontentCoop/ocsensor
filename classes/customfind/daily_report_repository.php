...
class SensorDailyReportRepository extends OCCustomSearchableRepositoryAbstract implements OCCustomSearchableRepositoryObjectCreatorInterface
{
    ...
    public function find(OCCustomSearchParameters $parameters)
    {
        ...
        $result = new SensorDailySearchResult($this);

        return $result->fromArrayResult($resultArray);
    }

    private function addPivotToQueryParams($filterParams, $queryParams)
    {
    ...
    private function addStatsToQueryParams($filterParams, $queryParams)
    {
