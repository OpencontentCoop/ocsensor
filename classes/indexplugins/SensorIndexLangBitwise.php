...
class SensorIndexLangBitwise implements ezfIndexPlugin
{
    ...
    public function modify(eZContentObject $contentObject, &$docList)
    {
        ...
        $extraFields = $this->getExtraFields($contentObject);
    ...
    public function getExtraFields(eZContentObject $contentObject)
    {
        $version = $contentObject->currentVersion();
        if ($version === false) {
            return [];
    ...
    public function getExtraFieldString($languageCode)
    {
