...
class SensorScenarioObserverFieldConnector extends FieldConnector
{
    private $operators;
    ...
    public function __construct($attribute, $class, $helper)
    {
        ...
        foreach (OpenPaSensorRepository::instance()->getGroupsTree()->attribute('children') as $child) {
            $this->operators['id_' . $child->attribute('id')] = ' • Gruppo ' . $child->attribute('name');
        }
