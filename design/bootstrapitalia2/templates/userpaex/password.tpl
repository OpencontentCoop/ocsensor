        ...
        <form action={concat($module.functions.password.uri,"/",$userID)|ezurl} method="post" name="Password">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input id="pwd-input" type="password" class="form-control" name="newPassword" size="11"
                           value="{$newPassword}"/>
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" class="form-control" name="confirmPassword" size="11"
            ...
            <div class="buttonblock">
                <input class="btn btn-default pull-left" type="submit" name="CancelButton"
                       value="{'Cancel'|i18n('mbpaex/userpaex')}"/>
                <input class="btn btn-primary pull-right" type="submit" name="OKButton"
                       value="{'OK'|i18n('mbpaex/userpaex')}"/>
            </div>
