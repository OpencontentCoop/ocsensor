...
{set-block scope=root variable=subject}[{$social_pagedata.site_title}] {$node.contentobject_id}: {'Modifica scadenza'|i18n('sensor/mail/post')}{/set-block}
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                    <tr>
                        <td align='center' valign='top'>
                            <h2>{'La scadenza della segnalazione è stata modificata'|i18n('sensor/mail/post')}</h2>
                        </td>
                    </tr>
                    <tr>
