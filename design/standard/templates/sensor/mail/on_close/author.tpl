...
{set-block scope=root variable=subject}[{$social_pagedata.site_title}] #{$node.contentobject_id}: {$subject|wash()}{/set-block}
            ...
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                ...
                <tr>
                    <td align='center' bgcolor='#f90f00' valign='top'>
                        <h3><a href="https://{$social_pagedata.site_url}/sensor/posts/{$object.id}" style="color: #ffffff !important">{"Visualizza la storia della tua segnalazione"|i18n('sensor/mail/post')}</a></h3>
                    </td>
                </tr>
                <tr>
                    <td align='center' valign='top'>
