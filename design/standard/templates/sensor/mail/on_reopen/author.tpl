            ...
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    <td align='center' valign='top'>
                        <h2>{'La tua segnalazione è stata registrata'|i18n('sensor/mail/post')}</h2>
                        <p>{'La tua segnalazione sarà presa in carico da un operatore al più presto'|i18n('sensor/mail/post')}</p>
                    </td>
                </tr>
                <tr>
                    <td align='center' valign='top'>
...
{set-block scope=root variable=subject}[{$social_pagedata.site_title}] {$node.contentobject_id}: {'La tua segnalazione è stata presa in carico'|i18n('sensor/mail/post')}{/set-block}
{set-block scope=root variable=body}
<table border='0' cellpadding='30' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='600'>
    <tr>
        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    <td align='center' valign='top'>
                        <h2>{'La tua segnalazione è stata presa in carico'|i18n('sensor/mail/post')}</h2>
                    </td>
                </tr>
                <tr>
                    <td align='left' style='border-top: 1px solid #dce1e5;border-bottom: 1px solid #dce1e5;' valign='top'>
...
{set-block scope=root variable=subject}[{$social_pagedata.site_title}] {$node.contentobject_id}: {"La tua segnalazione è stata chiusa dall'operatore"|i18n('sensor/mail/post')}{/set-block}
{set-block scope=root variable=body}
<table border='0' cellpadding='30' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='600'>
    <tr>
        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
...
{set-block scope=root variable=subject}[{$social_pagedata.site_title}] {$node.contentobject_id}: {'La tua segnalazione è stata risolta'|i18n('sensor/mail/post')}{/set-block}
{set-block scope=root variable=body}
<table border='0' cellpadding='30' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='600'>
    <tr>
        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    <td align='center' valign='top'>
                        <h2>{'La tua segnalazione è stata risolta'|i18n('sensor/mail/post')}</h2>
                    </td>
                </tr>
                <tr>
                    <td align='left' style='border-top: 1px solid #dce1e5;border-bottom: 1px solid #dce1e5;' valign='top'>
                ...
                <tr>
                    <td align='center' bgcolor='#f90f00' valign='top'>
                        <h3><a href="http://{$social_pagedata.site_url}/sensor/posts/{$object.id}" style="color: #ffffff !important">{"Visualizza la storia della tua segnalazione"|i18n('sensor/mail/post')}</a></h3>
                    </td>
                </tr>
                <tr>
                    <td align='center' valign='top'>
