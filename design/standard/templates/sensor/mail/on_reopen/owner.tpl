...
{set-block scope=root variable=subject}[{$social_pagedata.site_title}] {$node.contentobject_id}: {'Ti è stata assegnata una segnalazione'|i18n('sensor/mail/post')}{/set-block}
            ...
            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                <tr>
                    <td align='center' valign='top'>
                        <h2>{"Ti è stata assegnata una segnalazione"|i18n('sensor/mail/post')}</h2>
                        <p>{"Puoi decidere se risolvere la segnalazione o assegnarla a un altro operatore"|i18n('sensor/mail/post')}</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align='center' bgcolor='#f90f00' valign='top'>
                        <h3><a href="http://{$social_pagedata.site_url}/sensor/posts/{$object.id}" style="color: #ffffff !important">{"Leggi la segnalazione"|i18n('sensor/mail/post')}</a></h3>
                    </td>
                </tr>
                <tr>
                    <td align='center' valign='top'>
