...
<div class="pull-left add-class">
    <a class="btn btn-info" href="{concat('exportas/csv/',$faq_class,'/',$faq_parent_node.node_id)|ezurl(no)}">{'Esporta in CSV'|i18n('sensor/config')}</a>
</div>
<div class="pull-right add-class">
    <a class="btn btn-danger" id="add" data-add-parent="{$faq_parent_node.node_id}" data-add-class="{$faq_class}" href="{concat('add/new/', $faq_class,'/?parent=',$faq_parent_node.node_id)|ezurl(no)}"><i class="fa fa-plus"></i> {'Aggiungi'|i18n('sensor/config')}</a>
</div>
