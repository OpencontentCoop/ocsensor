      ...
      var datatable = resultsContainer.opendataDataTable({
        ...
        datatable: {
          ...
          columns: [
            ...
            {data: "metadata.name." + $.opendataTools.settings('language'), name: 'name', title: '{/literal}{'Name'|i18n( 'design/admin/node/view/full' )}{literal}'},
            {data: "metadata.published", name: 'published', title: '{/literal}{'Published'|i18n( 'design/admin/node/view/full' )}{literal}'},
            ...
            {data: "metadata.id", name: 'id', title: '', "searchable": false, "orderable": false, width: '1'},
            {data: "metadata.classIdentifier", name: 'class', title: '', "searchable": false, "orderable": false, width: '1'},
            {data: "metadata.remoteId", name: 'remote_id', title: '', "searchable": false, "orderable": false, width: '1'}
          ],
          columnDefs: [
            {
