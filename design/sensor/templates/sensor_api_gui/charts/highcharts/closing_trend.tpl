            ...
            load: function (chart, params) {
                ...
                $.getJSON('/api/sensor/stats/' + chart.data('identifier'), params, function (response) {
                    $.each(response, function () {
                        ...
                        //     helpList.append('<li class="list-group-item" style="font-weight: bold">'+$.sensorTranslate.translate('List of category ids for api selection')+' <code>&category[]=...&category[]=...<id></code></li>');
