...
<div class="row">
    ...
    <div class="col-xs-10 col-md-10">
        ...
        <div class="comment_date"><i class="fa-time"></i>
            ...
            {if and( $message.creator_id|eq(fetch(user,current_user).contentobject_id), $sensor_post.can_comment )}
        ...
        <div class="the_comment">
            {if and( $message.creator_id|eq(fetch(user,current_user).contentobject_id), $sensor_post.can_comment )}
                <div id="edit-message-{$message.id}" style="display: none;">
                    <textarea name="Collaboration_SensorEditComment[{$message.id}]" class="form-control" rows="3">{$message.data_text1}</textarea>
